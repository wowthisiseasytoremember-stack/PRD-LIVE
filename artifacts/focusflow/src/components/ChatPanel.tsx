...
function MessageBubble({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`w-2.5 h-2.5 rounded-full ${isUser ? "bg-secondary" : "bg-primary"}`}
        />
      </div>

      {/* Content */}
      <div
        className={`flex flex-col gap-1 min-w-0 max-w-[88%] ${isUser ? "items-end" : "items-start"}`}
      >
        ...
        {annotation ? (
          ...
          <div
            className={`px-3 py-2.5 rounded-lg text-sm whitespace-pre-wrap leading-relaxed break-words ${
              isUser
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Blueprint building on the right →
              </p>
            </div>
              ...
              <div className="h-full flex flex-col items-center justify-center max-w-xs mx-auto py-8 gap-6">
                <div className="text-center space-y-2 opacity-70">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Describe any project. FocusFlow breaks it into 45–90 min
                    sessions and routes each to the optimal AI.
                  </p>
                </div>
        ...
        {isStreaming ? (
          ...
          <div className="relative rounded-lg border border-primary/25 bg-card overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <span className="text-[10px] text-muted-foreground/60 font-mono truncate max-w-[45%]">
